...
local AttackModule = require "modules.player.attack_module";
local AbilityTickEffect = require "objects/Player/AbilityTickEffect";
local TrailParticle = require "modules.player.trail_particle";
...
function Player:set_attack_type(attack_type)
  self.attack_module:set_attack_type(attack_type);
end

function Player:add_ammo(amount)
  self.attack_module:add_ammo(amount);
end
